...
{
    public class WindowsPowerShellColorScheme : IColorScheme
    {
        ...
        public Color Yellow { get; set; } = Color.FromArgb(238,237,240);
        public Color Blue { get; set; } = Color.FromArgb(0, 0, 128);
        public Color Magenta { get; set; } = Color.FromArgb(1,36,86);
